          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <div className="flex flex-wrap md:flex-col md:gap-2 items-center self-start mt-2 lg:self-center">
                ...
                <Link href="mailto:nabeelahmed3129@gmail.com" target={"_blank"} className="ml-4 text-lg font-medium capitalize text-dark underline underline-offset-2 dark:text-light md:text-base md:m-0">Contact</Link>
              </div>
            </div>
          </div>
        </Layout>
