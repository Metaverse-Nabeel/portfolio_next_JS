...
const Article = ({ img, title, date, link }) => {
    return (
        <motion.li intial={{y:200}} whileInView={{y:0, transition:{duration:0.5, ease:easeInOut}}} viewport={{once: true}} className="relateive w-full p-4 py-6 my-4 rounded-xl flex items-center justify-between bg-light first:mt-0 border border-solid border-dark border-r-4 border-b-4">
